...
"
              >
                ...
                {/* Decorative Pattern Background based on user images */}
                <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden opacity-[0.03]">
                  {index % 2 === 0 ? (
                    <ConcentricCircles size={800} rings={15} baseColor="#1A1A1A" altColor="transparent" className="absolute -top-[50%] -right-[20%] w-[120%] h-[200%]" />
                  ) : (
                    <DotGrid dotSize={20} gap={15} rows={12} cols={30} color="#1A1A1A" className="absolute -top-[20%] -left-[10%] w-[120%] h-[150%]" />
                  )}
                </div>
...
"
            ><a href="https://chat.whatsapp.com/Iy2viZRf56AHEgeHE6KXRw" target="_blank" rel="noopener noreferrer">
