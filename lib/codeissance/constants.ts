...
export const TIMELINE_EVENTS: TimelineEvent[] = [
  { id: "reporting", time: "08:00", label: "Reporting Time", day: 1 },
  { id: "inauguration", time: "10:00", label: "Inauguration", day: 1, fontSize: "text-3xl sm:text-3xl md:text-4xl" },
  ...
  { id: "shortlist", time: "13:00", label: "Shortlisting", day: 2, fontSize: "text-2xl sm:text-3xl md:text-5xl" },
